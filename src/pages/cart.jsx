            ...
            <div className="grid grid-cols-1 lg:grid-cols-[2fr_320px] gap-10 md:px-0 px-5 relative">
                      ...
                      <div className="flex flex-col md:flex-row items-start w-full gap-5">
                        <div className="flex flex-col justify-center items-center w-full">
                          <Image
                            ...
                            height={200}
                          />
                          <div className="flex items-center gap-3 mt-4 bg-green-500 text-white px-2 py-1.5 rounded-md lg:w-auto md:w-auto w-full justify-between">
                            <button
                        ...
                        <div className="space-y-3 w-full md:mt-0 mt-5">
              ...
              <div className="">
                <button
                  ...
                  className="w-full bg-teal-500 hover:bg-teal-400 text-white font-bold py-3 rounded shadow"
                >
                  PLACE ORDER
                </button>
              </div>
